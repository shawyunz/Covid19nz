...
{
    public partial class CovidCaseOld
    {
    ...
    public partial class CovidCaseOld
    {
        public static List<CovidCaseOld> FromJson(string json) => JsonConvert.DeserializeObject<List<CovidCaseOld>>(json, Converter.Settings);
